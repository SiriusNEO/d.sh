...
An independent implementation inspired by [deepseek-ai/deepseek-harness](https://github.com/deepseek-ai/deepseek-harness) (MIT); the persona and tool schemas are adapted from its `sdk-minimal` bundle (MIT).
